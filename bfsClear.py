...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--image', type=str, help='input image directory', default='./dataset/land_train')
    parser.add_argument('-o', '--output', type=str, help='output image directory', default='./dataset/cleared_label')
